...
== Features
-  **Add a reminder feature** , link:https://opfab.github.io/documentation/current/docs/single_page_doc.html#card_reminder[see documentation] ([OC-1093] [OC-1230] [OC-1239])
...
- **Response cards**:
  ** [OC-1190] Add an option in card to keep child card, link:https://opfab.github.io/documentation/current/docs/single_page_doc.html#_send_a_question_card[see documentation]
- **Card Feed**: 
...
- [OC-1203] Refactor definition of detail in bundle, link:https://opfab.github.io/documentation/current/docs/single_page_doc.html#_migration_guide_from_release_1_7_0_to_release_1_8_0[see changes]
