...
- [OC-1242] View repeating events in timeline
 -[OC-1272] Add the possibility to show ack button only if action is disabled for the user. The configuration of the acknowledge has changes see migration documentation 
